...
import { loginComEmail, loginComGoogle, isIOS } from '@/lib/firebase/auth'
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="mt-4 flex justify-between text-xs">
            <Link href="/recuperar-senha" className="text-orange-500 hover:underline">Esqueceu a senha?</Link>
            <Link href="/registro" className="text-gray-500 hover:text-gray-700">Criar conta</Link>
          </div>
        </div>
      </div>
    </div>
