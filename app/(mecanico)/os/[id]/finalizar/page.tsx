  ...
  if (!os) {
    return (
      <div className="text-center py-20">
        ...
        <Link href="/os" className="btn-primary mt-4 inline-flex">Voltar</Link>
      </div>
    )
  }
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="space-y-4">
        ...
        <div className="card">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
            {([
              ...
              <button key={op.val} type="button" onClick={() => setFormaPagamento(op.val)}
        ...
        <button onClick={handleFinalizar} disabled={loadingAcao}
          ...
          <DollarSign size={17} />
          {loadingAcao ? 'Finalizando e baixando estoque...' : `Finalizar OS — R$${valorTotal.toFixed(2)}`}
        </button>
      </div>
    </div>
  )
